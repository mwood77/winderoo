...
> :warning: This assembly may require epoxy glue and sandpaper/filling. The driveshaft assembly is a tight, friction fit, and must be centered inside the jig’s bore.
...
1. Do a partial test fit  of the driveshaft/rod assembly and the jig/collar assembly. The driveshaft assembly should start to drive into the collar's bore with a the same twist/push motion you used to drive the metal rod through the driveshaft. **DO NOT FULLY SEAT THE ASSEMBLIES YET**. Now do the following:
    ...
    - Take the driveshaft and jig assemblies in your hands; align the metal rod in the center of the `watch_jig_collar`'s bore. This should self-center. Place the jig assembly upside down on a flat surface and *gently* push the `watch_jig_driveshaft` down the bore until it fully seats. Pick up the complete assembly and verify that the driveshaft is vertically aligned and the assembly rotates true. Leave the assembly upside dow (driveshaft points to the sky) and allow the epoxy to dry.
...
> :warning: This assembly may require epoxy glue and sandpaper/filling. The outter pulley and inner pulley mount should be a tight friction fit. However, not all 608ZZ bearings are made equal and may require a touch of glue to secure the models to the bearing.
...
> :warning: This assembly may require sandpaper/filling. The fitment between the `mounting_dowel` and `mounting_dowel_sleeve` is a tight friction fit.
...
1. Lay each plate on flat surface, then lay a ***608ZZ bearing*** overtop of the center housing of each plate.
