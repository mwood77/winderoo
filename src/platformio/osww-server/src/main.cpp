...
// int directionalPinA = 2;
// int directionalPinB = 4;
// int directionalPinC = 16;
// int directionalPinD = 17;
// int ledPin = 0;
...
// 	MotorControl motor(directionalPinA, directionalPinB, directionalPinC, directionalPinD);
// #else
...
AccelStepper stepper(AccelStepper::HALF4WIRE, 2, 16, 4, 17);

void setup() {
    stepper.setMaxSpeed(1500);  // Set max speed slightly above required speed
    stepper.setAcceleration(1000);
    stepper.setSpeed(1365); // Set speed for ~40 RPM
}
